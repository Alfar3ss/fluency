...
const questions = [
  { q: "Lei ___ dall'Italia.", options: ["viene", "vieni", "vengo", "vengono"], answer: 0 },
  { q: "Noi ___ i nostri compiti.", options: ["facciamo", "fai", "fanno", "faccio"], answer: 0 },
  { q: "Non c'è ___ latte nel frigorifero.", options: ["uno", "una", "nessun", "nessuno"], answer: 2 },
  { q: "Parla italiano ___ di suo fratello.", options: ["bene", "meglio", "più", "molto"], answer: 1 },
  { q: "Se avessi più tempo, ___ un'altra lingua.", options: ["imparo", "imparerei", "imparassi", "imparata"], answer: 1 },
];
  ...
  return (
    <main className="bg-[#f3f6f8] min-h-screen flex items-center justify-center py-12 px-2">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8">
        <h1 className="text-2xl font-extrabold text-[#127db2] mb-2 text-center">FLUENCY – ITALIAN PLACEMENT TEST</h1>

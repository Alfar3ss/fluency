...
const questions = [
  { q: "Sie ___ aus Deutschland.", options: ["kommt", "komme", "kommen", "kommst"], answer: 0 },
  { q: "Wir ___ unsere Hausaufgaben.", options: ["machen", "macht", "machst", "gemacht"], answer: 0 },
  { q: "Es gibt ___ Milch im Kühlschrank.", options: ["viel", "viele", "vielen", "vieles"], answer: 0 },
  { q: "Er spricht Deutsch ___ als sein Bruder.", options: ["gut", "besser", "mehr", "sehr"], answer: 1 },
  { q: "Wenn ich mehr Zeit hätte, ___ ich eine andere Sprache.", options: ["lerne", "würde lernen", "lernst", "gelernt"], answer: 1 },
];
  ...
  return (
    <main className="bg-[#f3f6f8] min-h-screen flex items-center justify-center py-12 px-2">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8">
        <h1 className="text-2xl font-extrabold text-[#127db2] mb-2 text-center">FLUENCY – GERMAN PLACEMENT TEST</h1>

...
const questions = [
  { q: "Elle ___ du Canada.", options: ["vient", "venez", "venir", "venue"], answer: 0 },
  { q: "Nous ___ nos devoirs.", options: ["finissons", "finir", "finissez", "fini"], answer: 0 },
  { q: "Il n'y a pas ___ lait dans le frigo.", options: ["de", "du", "des", "la"], answer: 0 },
  { q: "Elle parle français ___ mieux que son frère.", options: ["bien", "mieux", "plus", "très"], answer: 1 },
  { q: "Si j'___ plus de temps, j'apprendrais une autre langue.", options: ["avais", "ai", "aurai", "aurais"], answer: 0 },
];
  ...
  return (
    <main className="bg-[#f3f6f8] min-h-screen flex items-center justify-center py-12 px-2">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8">
        <h1 className="text-2xl font-extrabold text-[#127db2] mb-2 text-center">FLUENCY – FRENCH PLACEMENT TEST</h1>
